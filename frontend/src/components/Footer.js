        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/history" className="text-gray-400 hover:text-white transition">📜 Histoire</a></li>
              <li><a href="/success" className="text-gray-400 hover:text-white transition">🏆 Succès</a></li>
              <li><a href="/market" className="text-gray-400 hover:text-white transition">📈 Marché</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>📊 Nintendo Financial Reports</li>
              <li>🎮 VGChartz & Wikipedia</li>
              <li>📈 eBay Market Data</li>
              <li>🏪 PriceCharting.com</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-400">
              <p>📅 Données mises à jour : Mars 2025</p>
              <p>⚠️ Ce site est un projet éducatif</p>
              <p>🔒 Toutes les marques appartiennent à leurs propriétaires respectifs</p>
            </div>
          </div>
        </div>
